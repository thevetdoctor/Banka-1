...
document.addEventListener('DOMContentLoaded', () => {
	...
	var lgaSel = document.querySelector("#lgaSel");
		var lgaDiv = document.querySelector(".BB__lga");
	lgaDiv.style.display = "none";
	//Load States
	for(let state in stateLocal) {
		let newState = stateLocal[state]['state']
	...
	stateSel.addEventListener('change', (e) => {
			...
			const stateAndLocal = stateLocal.filter(lga => {
				return lga.state.id == e.target.value
			})
