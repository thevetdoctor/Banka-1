...
const routes = (app) => {
  ...
  app.post('/api/v1/accounts', userAuthenticate.authenticateUser, ValidateAccount.validateCreateAccount,
    ValidateAccount.checkDuplicateAccount, AccountsController.createAccount);
  app.put('/api/v1/account/:accountNumber', userAuthenticate.authenticateAdmin, ValidateAccount.validateAccountNumber,
    ValidateAccount.validateAccountStatus, AccountsController.updateAccountStatus);
  app.delete('/api/v1/accounts/:accountNumber', userAuthenticate.authenticateAdmin, ValidateAccount.validateAccountNumber,
    AccountsController.deleteBankAccount);
  app.post('/api/v1/transactions/:accountNumber/credit', userAuthenticate.authenticateStaff,
    ValidateAccount.validateAccountNumber, ValidateTransaction.validateCreditAccount, TransactionsController.creditAccount);
  app.post('/api/v1/transactions/:accountNumber/debit', userAuthenticate.authenticateStaff,
  ...
  app.get('/api/v1/accounts/:accountNumber', userAuthenticate.authenticateUser, ValidateAccount.validateAccountNumber,
    AccountsController.getUserAccount);
